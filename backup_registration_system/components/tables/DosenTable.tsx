                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">
                      {dosen.user_id ? `ID Akun: ${dosen.user_id}` : 'Belum Aktivasi'}
                    </div>
                  </div>
                </div>
              </TableCell>
                ...
                <div className="flex justify-end gap-2">
                  {!dosen.user_id && (
                    <Button
                      ...
                      size="sm"
                      onClick={() => {
                        const url = `${window.location.origin}/auth/activate?id=${dosen.nidn}`;
                        navigator.clipboard.writeText(url);
                        alert('Link aktivasi dosen berhasil disalin ke clipboard!');
                      }}
                    >
                      Undang
                    </Button>
